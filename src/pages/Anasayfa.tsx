      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600 rounded-2xl text-white p-8 shadow-lg transform hover:scale-[1.02] transition-transform duration-300">
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              to="/urunler/ekle"
              className="bg-white text-indigo-600 px-6 py-3 rounded-xl font-medium hover:bg-opacity-90 transition-all duration-300 flex items-center transform hover:translate-y-[-2px] hover:shadow-lg"
            >
